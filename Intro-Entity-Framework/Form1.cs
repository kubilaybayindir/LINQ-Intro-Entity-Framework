...
namespace Intro_Entity_Framework
{
    public partial class Form1 : Form
    {
        ...
        private void BtSixLetter_Click(object sender, EventArgs e)
        {
            ...
            //LINQ QUERY WITH EXTENSION MEDTHODS
            IEnumerable<string> query = GenerateName().Where(name => name.Length == 6).Select(name => name.ToUpper());
            listBox1.DataSource = query.ToList();
        }
        ...
        private void BtAz_Click(object sender, EventArgs e)
        {
            ...
            IEnumerable<string> query = GenerateName().OrderBy(name => name);
            listBox1.DataSource = query.ToList();
        }
        ...
        private void BtZa_Click(object sender, EventArgs e)
        {
            ...
            IEnumerable<string> query = GenerateName().OrderByDescending(name => name);
            listBox1.DataSource = query.ToList();
        ...
        private void BtALetter_Click(object sender, EventArgs e)
        {
            ...
            IEnumerable<string> query = GenerateName().Where(name => name.StartsWith("A")).Select(n => n.ToUpper());
            listBox1.DataSource = query.ToList();
        ...
        private void BtRLetter_Click(object sender, EventArgs e)
        {
            ...
            IEnumerable<string> query = GenerateName().Where(name => name.ToUpper().EndsWith("R")).OrderBy(na => na).Select(n => n.ToUpper());
            listBox1.DataSource = query.ToList();
        }
